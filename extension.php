...
return [
	...
	*/
	...
	{
		Route::group(['prefix' => admin_uri().'/channels'], function()
		{
			Route::get('/', 'Makbash\Channels\Controllers\Admin\ChannelsController@index');
		});
	},
	...
	*/
	...
	'permissions' => function()
	{
		return [
			...
			'Makbash\Channels\Controllers\Admin\ChannelsController@index' => 'List Channels',
